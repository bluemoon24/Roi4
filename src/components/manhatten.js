...
function biggestCommonGrid(fill = false) {
  ...
  var res = 30
  var widths = [Math.round(Layout.canvas.size.width / res) * res]
  var heights = [Math.round(Layout.canvas.size.height / res) * res]
  Layout.tiles.forEach(function(d, idx) {
    console.log(
      d.layout.layout.width,
      Math.round(d.layout.layout.width / res) * res
    )
    console.log(
      d.layout.layout.height,
      Math.round(d.layout.layout.height / res) * res
    )
    widths.push(Math.round(d.layout.layout.width / res) * res)
    heights.push(Math.round(d.layout.layout.height / res) * res)
  ...
  console.log('w mmc of', widths, mdc(widths))
  console.log('h mmc of', heights, mdc(heights))

  Layout.tiles.forEach(function(d, idx) {
    console.log(
      d.layout.layout.width,
      Math.round(d.layout.layout.width / xgrid),
      xgrid * Math.round(d.layout.layout.width / xgrid)
    )
    console.log(
      d.layout.layout.x,
      Math.round(d.layout.layout.x / xgrid),
      xgrid * Math.round(d.layout.layout.x / xgrid)
    )
  })
}
